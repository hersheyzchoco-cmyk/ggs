...
return {
    UILibrary=UILibrary, ThemeManager=ThemeManager, SaveManager=SaveManager,
    Options=Options, Toggles=Toggles,
    aas_WorldList=aas_WorldList, aas_sortedWorldIndices=aas_sortedWorldIndices,
    aas_RaidList=aas_RaidList, aas_sortedRaidKeys=aas_sortedRaidKeys,
    aas_GateData=aas_GateData, aas_GateRanks=aas_GateRanks,
    aas_DefenseList=aas_DefenseList, aas_sortedDefenseKeys=aas_sortedDefenseKeys,
    aas_GachaList=aas_GachaList, aas_sortedGachaKeys=aas_sortedGachaKeys,
    aas_SwordList=aas_SwordList, aas_sortedSwordKeys=aas_sortedSwordKeys,
    aas_ProgressionList=aas_ProgressionList, aas_sortedProgressionKeys=aas_sortedProgressionKeys,
    aas_UpgradeSystemList=aas_UpgradeSystemList, aas_sortedUpgradeSystemKeys=aas_sortedUpgradeSystemKeys,
    aas_StarWorldList=aas_StarWorldList, aas_sortedStarWorldKeys=aas_sortedStarWorldKeys,
    aas_CraftList=aas_CraftList, aas_sortedCraftKeys=aas_sortedCraftKeys,
    aas_TrialList=aas_TrialList, aas_sortedTrialKeys=aas_sortedTrialKeys,
    aas_TitanRarityOrder=aas_TitanRarityOrder,
    aas_SwordPassiveRarityOrder=aas_SwordPassiveRarityOrder,
    aas_GrimoireRarityOrder=aas_GrimoireRarityOrder,
    aas_UpgradeStatKeys=aas_UpgradeStatKeys,
    aas_Upgrades2Config=aas_Upgrades2Config,
    aas_upgrades2SystemKey=aas_upgrades2SystemKey,
    aas_getWorldLabel=aas_getWorldLabel,
    aas_equipLoadout=aas_equipLoadout,
    aas_syncAllPlayerData=aas_syncAllPlayerData,
    aas_redeemAllCodes=aas_redeemAllCodes,
    aas_toggleAutoClaimAchievements=aas_toggleAutoClaimAchievements,
    aas_toggleAutoAvatar=aas_toggleAutoAvatar,
    aas_toggleAutoRank=aas_toggleAutoRank,
    aas_toggleAutoStat=aas_toggleAutoStat,
    aas_toggleAutoClaimRewards=aas_toggleAutoClaimRewards,
    aas_autoClick=aas_autoClick,
    aas_farmLoop=aas_farmLoop, aas_raidLoop=aas_raidLoop,
    aas_defenseLoop=aas_defenseLoop, aas_trialLoop=aas_trialLoop,
    aas_gateLoop=aas_gateLoop, aas_gachaLoop=aas_gachaLoop,
    aas_passiveLoop=aas_passiveLoop, aas_titanLoop=aas_titanLoop,
    aas_swordPassive1Loop=aas_swordPassive1Loop, aas_swordPassive2Loop=aas_swordPassive2Loop,
    aas_grimoire1Loop=aas_grimoire1Loop, aas_grimoire2Loop=aas_grimoire2Loop,
    aas_progressionLoop=aas_progressionLoop, aas_rangeUpgradeLoop=aas_rangeUpgradeLoop,
    aas_upgrades2Loop=aas_upgrades2Loop, aas_starLoop=aas_starLoop,
    aas_craftLoop=aas_craftLoop, aas_fuseAllLoop=aas_fuseAllLoop,
    aas_crowMonitorLoop=aas_crowMonitorLoop, aas_ballMonitorLoop=aas_ballMonitorLoop,
    aas_cleanup=aas_cleanup,
    aas_raidArenaExists=aas_raidArenaExists, aas_defenseArenaExists=aas_defenseArenaExists,
    aas_trialArenaExists=aas_trialArenaExists, aas_gateArenaExists=aas_gateArenaExists,
    aas_disableOtherRaids=aas_disableOtherRaids, aas_disableAllDefenses=aas_disableAllDefenses,
    aas_disableAllGachas=aas_disableAllGachas,
    aas_anyRaidActive=aas_anyRaidActive, aas_anyDefenseActive=aas_anyDefenseActive,
    aas_teleportToWorld=aas_teleportToWorld,
    aas_snapshotAndPauseActivities=aas_snapshotAndPauseActivities,
    aas_resumeFromSnapshot=aas_resumeFromSnapshot,
    aas_swordWorld0Loop=aas_swordWorld0Loop, aas_swordWorld8Loop=aas_swordWorld8Loop,
    aas_LoadoutAssignments=aas_LoadoutAssignments,
    aas_RaidLoadouts=aas_RaidLoadouts, aas_DefenseLoadouts=aas_DefenseLoadouts,
    aas_TrialLoadouts=aas_TrialLoadouts,
    aas_worldDropdowns=aas_worldDropdowns,
    aas_autoClickRunning=aas_autoClickRunning,
    aas_autoClaimAchievementsEnabled=aas_autoClaimAchievementsEnabled,
    aas_autoAvatarEnabled=aas_autoAvatarEnabled,
    aas_autoRankEnabled=aas_autoRankEnabled,
    aas_autoStatEnabled=aas_autoStatEnabled,
    aas_autoClaimRewardsEnabled=aas_autoClaimRewardsEnabled,
    aas_currentStatSelection=aas_currentStatSelection,
    aas_farmEnabled=aas_farmEnabled, aas_farmThread=aas_farmThread,
    aas_activeRaidKey=aas_activeRaidKey, aas_raidThread=aas_raidThread,
    aas_raidEnabled=aas_raidEnabled,
    aas_activeDefenseKey=aas_activeDefenseKey, aas_defenseThread=aas_defenseThread,
    aas_defenseEnabled=aas_defenseEnabled,
    aas_trialEnabled=aas_trialEnabled, aas_trialThreads=aas_trialThreads,
    aas_gateEnabled=aas_gateEnabled, aas_gateThread=aas_gateThread,
    aas_gateAutoArise=aas_gateAutoArise, aas_gateCooldown=aas_gateCooldown,
    aas_gateSuppressedByPriority=aas_gateSuppressedByPriority,
    aas_trialSuppressedByPriority=aas_trialSuppressedByPriority,
    aas_priorityChoice=aas_priorityChoice,
    aas_gachaEnabled=aas_gachaEnabled, aas_gachaThreads=aas_gachaThreads,
    aas_activeGachaRarities=aas_activeGachaRarities, aas_gachaLabelRefs=aas_gachaLabelRefs,
    aas_passiveAutoEnabled=aas_passiveAutoEnabled, aas_passiveThread=aas_passiveThread,
    aas_passiveLabelRef=aas_passiveLabelRef, aas_activePassiveData=aas_activePassiveData,
    aas_titanAutoEnabled=aas_titanAutoEnabled, aas_titanThread=aas_titanThread,
    aas_titanLabelRef=aas_titanLabelRef, aas_activeTitanData=aas_activeTitanData,
    aas_swordPassive1Enabled=aas_swordPassive1Enabled, aas_swordPassive1Thread=aas_swordPassive1Thread,
    aas_sword1Data=aas_sword1Data, aas_sword1CurrentBreathing=aas_sword1CurrentBreathing,
    aas_sword1InfoLabelRef=aas_sword1InfoLabelRef, aas_sword1BreathingLabelRef=aas_sword1BreathingLabelRef,
    aas_swordPassive2Enabled=aas_swordPassive2Enabled, aas_swordPassive2Thread=aas_swordPassive2Thread,
    aas_sword2Data=aas_sword2Data, aas_sword2CurrentBreathing=aas_sword2CurrentBreathing,
    aas_sword2InfoLabelRef=aas_sword2InfoLabelRef, aas_sword2BreathingLabelRef=aas_sword2BreathingLabelRef,
    aas_grimoire1Enabled=aas_grimoire1Enabled, aas_grimoire1Thread=aas_grimoire1Thread,
    aas_grimoire1LabelRef=aas_grimoire1LabelRef,
    aas_grimoire2Enabled=aas_grimoire2Enabled, aas_grimoire2Thread=aas_grimoire2Thread,
    aas_grimoire2LabelRef=aas_grimoire2LabelRef,
    aas_activeGrimoireSlot1=aas_activeGrimoireSlot1, aas_activeGrimoireSlot2=aas_activeGrimoireSlot2,
    aas_progressionEnabled=aas_progressionEnabled, aas_progressionThreads=aas_progressionThreads,
    aas_progressionLevels=aas_progressionLevels, aas_progressionLevelLabelRefs=aas_progressionLevelLabelRefs,
    aas_rangeUpgradeEnabled=aas_rangeUpgradeEnabled, aas_rangeUpgradeThreads=aas_rangeUpgradeThreads,
    aas_upgrades2Enabled=aas_upgrades2Enabled, aas_upgrades2Threads=aas_upgrades2Threads,
    aas_upgrades2Data=aas_upgrades2Data,
    aas_starEnabled=aas_starEnabled, aas_starThread=aas_starThread, aas_starEggKey=aas_starEggKey,
    aas_craftEnabled=aas_craftEnabled, aas_craftThreads=aas_craftThreads, aas_craftShiny=aas_craftShiny,
    aas_autoCrowEnabled=aas_autoCrowEnabled, aas_crowThread=aas_crowThread,
    aas_crowClaiming=aas_crowClaiming,
    aas_autoBallEnabled=aas_autoBallEnabled, aas_ballThread=aas_ballThread,
    aas_ballClaiming=aas_ballClaiming,
    aas_autoFuseAllEnabled=aas_autoFuseAllEnabled, aas_fuseAllThread=aas_fuseAllThread,
    aas_swordWorld0Enabled=aas_swordWorld0Enabled, aas_swordWorld0Thread=aas_swordWorld0Thread,
    aas_swordWorld8Enabled=aas_swordWorld8Enabled, aas_swordWorld8Thread=aas_swordWorld8Thread,
    aas_swordThreads=aas_swordThreads,
    AAS_DIVINE=AAS_DIVINE,
}
